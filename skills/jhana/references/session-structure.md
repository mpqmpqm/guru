...
Phase timing, duration options, and structural templates. Generate language fresh; use these structures to pace and proportion the session.
...
### Energy Body Session (30 minutes)
...
**Objective**: Release arrival tension, establish physical ease, set non-achievement frame
...
4. Non-achievement framing (essential setup for later phases)

**Transition to Access**: No explicit marker needed. Shift topic from body-ease to breath-attention.
...
4. Allow breath subtlety without correction
5. Extended silence with minimal cues

**Breath subtlety note**: If breath becoming very shallow/subtle is referenced, frame as natural and correct. Never imply deeper breathing is needed.

**Transition to Shift**: Time-based. After full access duration, introduce pleasant sensation regardless of presumed state.

---

### Shift

**Objective**: Redirect attention to pleasant sensation without grasping
...
4. Release breath object explicitly
5. Core instruction: pleasantness-quality, not characteristics
6. "Do nothing else" equivalent (generate fresh language)
7. Extended silence
...
**Transition to Jhana holding**: After core instruction delivered and brief settling time, enter minimal-cue holding.

---

### Jhana Holding

**Objective**: Create space for state to develop without interference
...
**Structural arc**: Essentially flat. This is held space, not guided progression.

**Duration**: Full allocated time regardless of presumed outcome.

---

### Second Jhana Transition

**Objective**: Shift from physical intensity to emotional quality
...
4. Return to minimal-cue holding

**When to skip**: If session time compressed, or if second jhana not part of session plan. Never rush this transition.

---

### Emergence

**Objective**: Gradual return, integration, non-failure framing
...
4. Room/environment awareness
5. Whatever arose is complete (essential framing)
6. Permission for slow return

**Non-failure framing**: Final cues must convey that the session was valuable regardless of what arose. Never imply that jhana was expected or that not-jhana is disappointing.

---

## Silence Management

Extended silences are structural, not empty time.
...
- Shift: 20-45 seconds
- Jhana holding: 2-5 minutes
- Emergence: 10-20 seconds

**Silence after core instruction**: Minimum 60 seconds of pure silence after delivering the "do nothing else" equivalent before any further cue.
...
4. Do not add content—add silence

...
## The 7 archetypal poses (Grilley)
...
| **Dragonfly** | Inner groin, spine | Wide-legged forward fold, side bend variations |
| **Dragon** | Hip flexors, quadriceps | Low lunge, twisted, winged |
| **Twisted Roots/Deer** | Spine rotation | Supine twist, 90-90 position |
| **Sphinx/Seal** | Spine extension, front body | Arms closer (Sphinx) or extended (Seal) |

## Yin pose names vs. yang equivalents
...
| Dragon | Low lunge | Back knee down, passive hold |
| Saddle | Supta Virasana | Prop-supported, no muscular effort |
| Shoelace | Gomukhasana legs | No arm bind, forward fold optional |
| Sphinx/Seal | Bhujangasana | Passive backbend, arms support |
| Bananasana | Side-lying stretch | Gentle lateral extension |
| Toe Squat | — | Targets foot fascia, intense |
| Ankle Stretch | — | Kneeling on tops of feet |

## Meridian-based sequencing (Sarah Powers)
...
3. Rebound (1 min)
4. Half Saddle R/L (4 min each) — extension, quads
5. Rebound (1 min)
6. Caterpillar (5 min) — flexion, spine
7. Rebound (1 min)
8. Dragon R/L (4 min each) — extension, hip flexors
9. Rebound (1 min)
10. Swan R/L (5 min each) — external rotation, outer hip
11. Rebound (1 min)
12. Dragonfly (5 min) — lateral option, groin
13. Rebound (1 min)
14. Twisted Roots R/L (4 min each) — twist, spine
15. Rebound (1 min)
...
- Standalone: complete practice in itself
...
| Dragonfly (adduction stretch) | Knees to chest (neutral) |

The rebound serves as primary counterpose. Additional counterposes optional but helpful for strong holds.
...
3. Saddle (extension)
4. Sphinx (extension)
5. Swan (external rotation)
6. Twisted pose (rotation)

This progression moves through all spinal ranges systematically.
